                ...
                <div className='home_section1'>
                    <div className='section1_content1'>
                        ...
                        <div className='content1_links'>
                            <Link className='content1_link1'>what's new</Link>
                            <Link className='content1_link2'>enter the shop</Link>
                        </div>
                        </div>
                ...
                <div className='home_section2'>
                        ...
                        <div className='product'>
                            <div className='product_content'>
                                ...
                                <div className='perServing'>
                                    <span className='span_protein'>PROTEIN</span>
                                    <span className='span_protein_gram'>25 g</span>
                                    <span className='span_bcaa'>BCAA</span>
                                    <span className='span_bcaa_gram'>5.5 g</span>
                                    <span className='span_carb'>CARB</span>
                                    <span className='span_carb_gram'>25 g</span>
                                </div>
                                <div className='weight_and_price'>
                                    <span className='weight'>5 lb</span>
                    ...
                    <div className='section2_content2'>
                        <div className='section2_content2_tags'>
                            <button className='section2_content2_overview_tag' onClick={overviewNumHandler}>Overview</button>
                            <button className='section2_content2_fact_tag' onClick={factNumHandler}>Nutrition Fact</button>
                        </div>
                        <div className='section2_content2_overview'>
                            <NewProductOverview clicked={this.state.overviewNum}></NewProductOverview>
                        </div>
